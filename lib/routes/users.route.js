...
exports.userRoutes.post("/users", (0, express_async_handler_1.default)(users_controllers_1.userController.save));
// Endpoint para atualizar um utilizador existente
exports.userRoutes.put("/users/:id", (0, express_async_handler_1.default)(users_controllers_1.userController.update));
